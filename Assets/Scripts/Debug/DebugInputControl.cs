...
namespace Projectiles
{
    public class DebugInputControl : NetworkBehaviour
    {
        ...
        public override void Render()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Keypad6) == true || Input.GetKeyDown(KeyCode.U) == true)
            {
                SetActiveRunner(-1);
            }
            else if (Input.GetKeyDown(KeyCode.Keypad7) == true || Input.GetKeyDown(KeyCode.I) == true)
            {
                SetActiveRunner(0);
            }
            else if (Input.GetKeyDown(KeyCode.Keypad8) == true || Input.GetKeyDown(KeyCode.O) == true)
            {
                SetActiveRunner(1);
            }
            else if (Input.GetKeyDown(KeyCode.Keypad9) == true || Input.GetKeyDown(KeyCode.P) == true)
            {
                SetActiveRunner(2);
            }
        }
