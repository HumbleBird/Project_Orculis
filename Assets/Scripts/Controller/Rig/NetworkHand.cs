...
namespace Fusion.XR.Host.Rig
{
    ...
    public class NetworkHand : NetworkBehaviour
    {
        ...
        public HardwareHand LocalHardwareHand ;//=> IsLocalNetworkRig ? (side == RigPart.LeftController ? rig.hardwareRig.m_LeftHandTransform : rig.hardwareRig.m_RightHandTransform) : null;
